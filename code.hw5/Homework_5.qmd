...
6.  **Introduction**
    ...
    This analysis revolves around a study conducted at Harvard Forest in 2005, which explored the impact of prey availability on Sarracenia physiology. Sarracenia, also known as pitcher plants, are carnivorous wetland flora indigenous to North America.

    The study asked a number of interesting questions, such as how prey availability affects Sarracenia growth and development, how prey capture is related to plant physiology, and what potential trade-offs may result from prey limiting. The researchers wanted to learn more about how Sarracenia responded to changing prey availability by testing these assumptions.

    (Farnsworth and Ellison)

    (Horner, Steele, Underwood, and Lingamfelter)
